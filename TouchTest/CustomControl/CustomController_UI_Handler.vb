Namespace CustomController_Data
    Public Interface CustomController_UI_Handler
        ...
        Function OpenFramework_LoadAppsDlls(User As UserManager) As List(Of OpenFrameworkAppInformation)
        Function OpenFramework_LoadPlugins_New() As List(Of OpenFrameworkAppInformation)
        Function OpenFramework_LoadPlugins(folder As String) As List(Of OpenFrameworkAppInformation)
