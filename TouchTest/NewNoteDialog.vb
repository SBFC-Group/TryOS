...
Public Class NewNoteDialog
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If My.Computer.FileSystem.DirectoryExists(UI.UserFolder & "\Notes") Then
            If My.Computer.FileSystem.FileExists(UI.UserFolder & "\Notes\quicknote_" & Number.ToString & ".swnote") Then
                Number = Number + 1
                Button1_Click(Me, e)
            Else
                ...
                Dim TempFolder As String = UI.UserFolder & "\Temp"
                ...
                My.Computer.FileSystem.MoveFile(TempFolder & "\quicknote_" & Number.ToString & ".swnote", UI.UserFolder & "\Notes\quicknote_" & Number.ToString & ".swnote")
        ...
        Else
            Try
                My.Computer.FileSystem.CreateDirectory(UI.UserFolder & "\Notes")
                Button1_Click(Me, e)
